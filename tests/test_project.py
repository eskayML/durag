"""Tests for ``durag.client.project.Project.update`` — focused on the
...
def project():
    ...
    with patch("durag.client.project.capture_client_event"):
        from durag.client.project import Project
