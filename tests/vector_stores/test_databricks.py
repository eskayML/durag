...
from durag.vector_stores.databricks import Databricks
...
def mock_workspace_client():
    ...
    with patch("durag.vector_stores.databricks.WorkspaceClient") as mock_wc_cls:
        ...
        mock_wc.vector_search_indexes.create_index.return_value = SimpleNamespace(name="catalog.schema.durag")
        ...
        mock_wc.vector_search_indexes.get_index.return_value = SimpleNamespace(name="durag")
...
def test_config_rejects_old_doc_params():
    ...
    from durag.configs.vector_stores.databricks import DatabricksConfig
