...
# Configure logging
logging.getLogger("durag.vector.neptune.main").setLevel(logging.INFO)
logging.getLogger("durag.vector.neptune.base").setLevel(logging.INFO)
...
class TestNeptuneAnalyticsOperations:
    ...
    def test_list_cols(self, na_instance):
        ...
        assert result == ["DURAG_VECTOR_test"]
