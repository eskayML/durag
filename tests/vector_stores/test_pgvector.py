...
class TestPGVector(unittest.TestCase):
    ...
    @patch('durag.vector_stores.pgvector.PSYCOPG_VERSION', 3)
    @patch('durag.vector_stores.pgvector.ConnectionPool')
    ...
    @patch('durag.vector_stores.pgvector.PSYCOPG_VERSION', 2)
    @patch('durag.vector_stores.pgvector.ConnectionPool')
    ...
    def test_insert_psycopg2(self, mock_get_cursor, mock_connection_pool):
        ...
        with patch.dict('sys.modules', {
            ...
            if 'durag.vector_stores.pgvector' in sys.modules:
                importlib.reload(sys.modules['durag.vector_stores.pgvector'])
    ...
    @patch('durag.vector_stores.pgvector.ConnectionPool')
    @patch.object(PGVector, '_get_cursor')
    @patch('durag.vector_stores.pgvector.Json')
    ...
    def test_pool_cleanup_psycopg3(self):
        ...
        with patch('durag.vector_stores.pgvector.PSYCOPG_VERSION', 3), \
             patch('durag.vector_stores.pgvector.ConnectionPool') as mock_connection_pool:
    ...
    def test_pool_cleanup_psycopg2(self):
        ...
        with patch('durag.vector_stores.pgvector.PSYCOPG_VERSION', 2), \
             patch('durag.vector_stores.pgvector.ConnectionPool') as mock_connection_pool:
