...
from durag.configs.vector_stores.milvus import MetricType
from durag.vector_stores.milvus import MilvusDB
...
class TestMilvusDB:
    ...
    def mock_milvus_client(self):
        ...
        with patch('durag.vector_stores.milvus.MilvusClient') as mock_client:
