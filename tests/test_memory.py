...
from durag.memory.utils import normalize_facts
...
def test_search_handles_incomplete_payloads(mock_sqlite, mock_llm_factory, mock_vector_factory, mock_embedder_factory):
    ...
    from durag.memory.main import Memory as MemoryClass
    config = MemoryConfig()
...
@patch('durag.utils.factory.VectorStoreFactory.create')
@patch('durag.utils.factory.LlmFactory.create')
@patch('durag.memory.main.SQLiteManager')
