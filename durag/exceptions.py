"""Structured exception classes for Durag with error codes, suggestions, and debug information.
...
and recovery in applications using Durag.
...
class MemoryError(Exception):
    ...
    This is the base class for all Durag-specific exceptions. It provides a structured
...
class AuthenticationError(MemoryError):
    ...
    Example:
        raise AuthenticationError(
            ...
            error_code="AUTH_001",
            suggestion="Please check your API key in the Durag dashboard"
        )
    """
    pass
...
class NetworkError(MemoryError):
    ...
    Example:
        raise NetworkError(
            ...
            debug_info={"timeout": 30, "endpoint": "api.durag.ai"}
        )
    """
    pass
...
class ConfigurationError(MemoryError):
    ...
    Example:
        raise ConfigurationError(
            ...
            error_code="CFG_001",
            suggestion="Set DURAG_API_KEY environment variable or pass api_key parameter"
        )
    """
    pass
